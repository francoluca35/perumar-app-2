...
export async function POST(req) {
  try {
    ...
    // Verificamos si es respuesta válida con contenido JSON
    ...
    // ✅ Devolvemos directamente el contenido del backend (con preview plano)
    const data = await response.json();
    return NextResponse.json(data); // ✅ Este cambio es el que soluciona el problema
  } catch (err) {

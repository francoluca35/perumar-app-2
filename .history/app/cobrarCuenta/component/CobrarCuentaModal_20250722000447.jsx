...
export default function CobrarCuentaModal({
        ...
        try {
          ...
          if (data.status === "approved") {
            ...
            Swal.fire({
              ...
              try {
                await set(ref(realtimeDb, `tickets/${mesa.numero}`), {
                  mesa: mesa.numero,
  ...
  const liberarMesa = async (monto, metodoPago) => {
        ...
        <div className="bg-white rounded-2xl p-6 space-y-4 w-full max-w-md shadow-lg">
          ...
          <button
            onClick={async () => {
              ...
              // 5. Liberar la mesa
              await liberarMesa(totalFinal, "Efectivo");
    ...
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl p-6 space-y-4 w-full max-w-md shadow-lg">
          ...
          <button
            onClick={async () => {
              await liberarMesa(totalMP, metodo);

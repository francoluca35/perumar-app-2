...
export default function AgregarMenu() {
  ...
  const handleEliminar = async (id) => {
    if (!id) {
      ...
      return Swal.fire("Error", "ID inválido para eliminar", "error");
    }
    ...
    try {
      ...
      Swal.fire("Error", error.message || "Hubo un error al eliminar", "error");
    }
  };

  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-red-600 via-black to-blue-950 py-16 px-4">
      <div className="max-w-4xl h-screen mx-auto backdrop-blur-lg bg-white/5 rounded-3xl p-6 md:p-10 border border-gray-700 shadow-2xl relative overflow-hidden">
          ...
          >
            ...
            <div className="sm:col-span-2">
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold rounded-xl shadow-lg"
              >
              ...
              {productosPaginados?.map((p) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => handleEliminar(p.id || p._id || p.docId)}

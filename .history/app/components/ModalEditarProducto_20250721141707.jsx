...
export default function ModalEditarProducto({ producto, onClose, refetch }) {
  ...
  const guardarCambios = async () => {
    ...
    try {
      ...
      formData.append("id", producto.id || producto._id);
      ...
      const res = await fetch("/api/menu/editar2", {
        method: "PUT",
        body: formData,
      });
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-70 backdrop-blur-sm overflow-y-auto flex justify-center items-center px-4 py-10">
      <div className="bg-white text-black rounded-2xl p-6 w-full max-w-lg shadow-2xl max-h-screen overflow-y-auto">
